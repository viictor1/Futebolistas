 ...
 * @author victo
 */
@WebServlet(name = "RemoverJogadora", urlPatterns = {"/RemoverJogadora"})
public class RemoverJogadora extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if("".equals(request.getParameter("selectJ")) || request.getParameter("selectJ") == null){
            ...
            id = Integer.parseInt(request.getParameter("selectJ"));
        }
